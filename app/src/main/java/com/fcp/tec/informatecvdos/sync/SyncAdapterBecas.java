...
public class SyncAdapterBecas extends AbstractThreadedSyncAdapter
{

    private final String TAG = SyncAdapterBecas.class.getSimpleName();
    private final ContentResolver cResolver;


    public SyncAdapterBecas(Context context, boolean autoInitialize)
    {
                              ...
                              ContentProviderClient provider, SyncResult syncResult)
    {
        ...
        Log.i(TAG, "Sincronizando desde la URL_BECAS: " + UURLS.URL_BECAS);
    ...
    private void lecturaGET()
    {
        ...
        JsonObjectRequest getRequest = new JsonObjectRequest
                (Request.Method.GET, UURLS.URL_BECAS, new Response.Listener<JSONObject>()
                {
                    @Override
